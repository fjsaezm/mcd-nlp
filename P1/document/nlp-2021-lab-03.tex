...
\setcounter{section}{-1} % So the first section is 0
...
In particular, there might be more of each element inthe respective position (i.e., two adjectives, two adeverbs, etc.). We tested this in very simple examples.
